...
public class DingTai_shipmentcreateaction extends DevWorkflowAction {
    ...
    public ActionExecuteInfo execCode(RequestInfo requestInfo) {
        ...
        String getSqrSql="select sqr,sqrq from formtable_main_471 where requestid=?";
        ...
        try {
            ...
            params.put("requestName", "物品出门申请单-Shipment-" + ApplyDate);
            params.put("mainData", getFormMainData(requestId,imagepath));
     ...
     * @return
     */
    private  String  getFormMainData(String requestId,int imagepath){

        RecordSet rs=new RecordSet();

        String MainSql="SELECT sqlx1,chrq,jjrlxdh,sjrlxdh,sjr,khmc,swzp,sqr,sqrbm FROM formtable_main_471 a where requestid=?";
...
//        附件上传字段
    ...
    private String getFormDetailData(String requestId){
        ...
        String detailsql = "SELECT b.lotid3,b.lotqty FROM formtable_main_471_dt1 b LEFT JOIN formtable_main_471 a ON b.MAINID =a.ID where requestId=?";
