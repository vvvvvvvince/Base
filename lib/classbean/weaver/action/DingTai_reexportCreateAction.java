...
import com.weaver.util.dev.doc.DocUtils;
...
public class DingTai_reexportCreateAction extends DevWorkflowAction {
    ...
    public ActionExecuteInfo execCode(RequestInfo requestInfo) {
        ...
        String getSqrSql="select sqr,sqrq from formtable_main_470 where requestid=?";
        ...
        try {
            ...
            params.put("requestName", "物品出门申请单-Re-ex-" + ApplyDate);
            params.put("mainData", getFormMainData(requestId,imagepath,OutDoor));
     ...
     * @return
     */
    private  String  getFormMainData(String requestId,int imagepath,String OutDoor){

        RecordSet rs=new RecordSet();

        String MainSql="SELECT shgsdz,scswzp,sqsx,sqr,sqrbm,sqrdh1,sqsx,shgs,shgsdz,shgs,LXR,dh,sffh,qt,sqyy,wbcmqy,yjccsj,sfwwqxhwxdparts,djlx,yjfhsj　FROM formtable_main_470 a where requestid=?";
...
//        附件上传字段
        ...
        log.info(".................attachments upload SUCCESS! Attachement ID =="+result +"................................................");
    ...
    private String getFormDetailData(String requestId){
        ...
        String detailsql = "SELECT  b.lh,b.HWMC,b.SLDW,b.JC ,b.SFGDZC FROM formtable_main_470_dt1 b LEFT JOIN formtable_main_470 a ON b.MAINID =a.ID where requestId=?";
